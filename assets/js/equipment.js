const createEquipment = () => {
    ...
    if (equipment.attribute == "Damage") {
        const equipmentCategories = ["Axe", "Hammer", "Dagger", "Flail", "Nokia hammer", "Scythe", "Heavenly Demon Sword", "Sky Sword Saint", "Servant Heavenly Sword", "Dildo", "Pointy Hand", "Cross sword", "Whip", "Halberd", "Mace", "Morningstar", "Throwing Knives", "Warhammer", "Rapier", "Spear", "Battle Axe", "Glaive", "Chakram", "Nunchaku", "Cestus", "Gauntlet", "Katar", "Bolas", "War Fan", "Scimitar", "Twin Blades", "Flame blades", "Cutter", "Magic Book", "Boomerang", "Magic Card", "Slave", "Despair Slave", "Extra Large Hammer", "Hydra", "Gem Pendant"];
        ...
        if (equipment.type == "Armor") {
            const equipmentCategories = ["Plate", "Chain", "Leather", "Unknown", "Fire Ring"];
            equipment.category = equipmentCategories[Math.floor(Math.random() * equipmentCategories.length)];
    ...
    for (let i = 0; i < loopCount; i++) {
        ...
        let hpScaling = (100 * randomizeDecimal(0.5, 1.5)) + ((30 * randomizeDecimal(0.5, 1.5)) * statMultiplier);
        let atkDefScaling = (50 * randomizeDecimal(0.5, 1.5)) + ((12 * randomizeDecimal(0.5, 1.5)) * statMultiplier);
        let cdAtkSpdScaling = (2.5 * randomizeDecimal(0.5, 1.5)) + ((2.5 * randomizeDecimal(0.5, 1.5)) * statMultiplier);
        let crVampScaling = (5.0 * randomizeDecimal(0.5, 1.5)) + ((1.5 * randomizeDecimal(0.5, 1.5)) * statMultiplier);
        ...
        if (equipment.rarity == "Common" && loopCount > 3) {
            ...
            loopCount--;
        } else if (equipment.rarity == "Void" && loopCount > 15) {
            loopCount--;
        }
...
const equipmentIcon = (equipment) => {
    ...
    } else if (equipment == "Sword Of Saul") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Nokia hammer") {
        return '<i class="ra ra-microphone"></i>';
    } else if (equipment == "Heavenly Demon Sword") {
        return '<i class="ra ra-broadsword"></i>';
    } else if (equipment == "Boomerang") {
        return '<i class="ra ra-boomerang"></i>';
    } else if (equipment == "Magic Card") {
        return '<i class="ra ra-diamonds-card"></i>';
    } else if (equipment == "Fire Ring") {
        return '<i class="ra ra-fire-ring"></i>';
    } else if (equipment == "Gem Pendant") {
        return '<i class="ra ra-gem-pendant"></i>';
    } else if (equipment == "Hydra") {
        return '<i class="ra ra-hydra"></i>';
    } else if (equipment == "Extra Large Hammer") {
        return '<i class="ra ra-large-hammer"></i>';
    } else if (equipment == "Slave") {
        return '<i class="ra ra-player"></i>';
    } else if (equipment == "Despair Slave") {
        return '<i class="ra ra-player-despair"></i>';
    } else if (equipment == "Minecraft sword") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Cross sword") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Sky Sword Saint") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Unknown") {
        return '<i class="ra ra-aura"></i>';
    } else if (equipment == "Magic Book") {
        return '<i class="ra ra-book"></i>';
    } else if (equipment == "Whip") {
        return '<i class="ra ra-halberd"></i>';
    } else if (equipment == "Halberd") {
        return '<i class="ra .ra-halberd"></i>';
    } else if (equipment == "Mace") {
        return '<i class="ra ra-spiked-mace"></i>';
    } else if (equipment == "Morningstar") {
        return '<i class="ra ra-spiked-mace"></i>';
    } else if (equipment == "Throwing Knives") {
        return '<i class="ra ra-kunai></i>';
    } else if (equipment == "Warhammer") {
        return '<i class="ra ra-sea-serpent"></i>';
    } else if (equipment == "Rapier") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Spear") {
        return '<i class="ra ra-spear-head"></i>';
    } else if (equipment == "Battle Axe") {
        return '<i class="ra ra-crossed-axes"></i>';
    } else if (equipment == "Glaive") {
        return '<i class="ra ra-croc-sword"></i>';
    } else if (equipment == "Chakram") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Nunchaku") {
        return '<i class="ra ra-all-for-one"></i>';
    } else if (equipment == "Cestus") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Gauntlet") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Katar") {
        return '<i class="ra ra-daggers"></i>';
    } else if (equipment == "Bolas") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "War Fan") {
        return '<i class="ra ra-death-skull"></i>';
    } else if (equipment == "Scimitar") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Twin Blades") {
        return '<i class="ra ra-diving-dagger"></i>';
    } else if (equipment == "Flame blades") {
        return '<i class="ra ra-spinning-sword"></i>';
    } else if (equipment == "Cutter") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Servant Heavenly Sword") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Dildo") {
        return '<i class="ra ra-relic-blade"></i>';
    } else if (equipment == "Pointy Hand") {
        return '<i class="ra ra-relic-blade"></i>';
...
const createEquipmentPrint = (condition) => {
    ...
    if (condition == "combat") {
        ...
        addDungeonLog(`
        The merchant give you <span class="${item.rarity}">${item.rarity} ${item.category}</span> and leave.<br>${panel}`);
    }
